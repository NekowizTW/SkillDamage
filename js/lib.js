// code from https://github.com/lockevn/html-numeric-input
...
function forceRemoveEvent(inputElementId) {
    var textbox = document.getElementById(inputElementId);
    textbox.removeEventListener("keydown", function(){});
    textbox.removeEventListener("keyup", function(){});
